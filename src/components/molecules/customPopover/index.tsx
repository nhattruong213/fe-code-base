import { alpha, menuItemClasses, Popover, PopoverOrigin, styled } from '@mui/material';

import { bgBlur } from '@/styles/theme/css';

import { MenuPopoverArrowValue, MenuPopoverProps } from './type';
...
export const CustomPopover = ({ open, children, arrow = 'top-right', hiddenArrow, sx, ...other }: MenuPopoverProps) => {
